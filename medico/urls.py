...
urlpatterns = [
    ...
    path('retirer_un_du_panier/<int:item_id>/', views.retirer_un_du_panier, name='retirer_un_du_panier'),
    path('ajouter_un_au_panier/<int:item_id>/', views.ajouter_un_au_panier, name='ajouter_un_au_panier'),
